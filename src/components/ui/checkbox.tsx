...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ...
    className={cn(
      ...
      'data-[state=indeterminate]:[&_[data-checkbox-visual]]:bg-primary data-[state=indeterminate]:[&_[data-checkbox-visual]]:border-primary',
      className
    )}
    {...props}
  >
    ...
    >
      <CheckboxPrimitive.Indicator className="flex items-center justify-center">
        {props.checked === 'indeterminate' ? (
          <Square className="size-1.5 fill-current" strokeWidth={0} />
        ) : (
