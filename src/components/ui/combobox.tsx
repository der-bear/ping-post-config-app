...
function ComboboxList({ className, ...props }: ComboboxPrimitive.List.Props) {
  return (
    <ComboboxPrimitive.List
      ...
      className={cn(
        "max-h-[min(calc(--spacing(96)---spacing(9)),calc(var(--available-height)---spacing(9)))] scroll-py-1 overflow-y-auto p-1 data-empty:p-0 pointer-events-auto overscroll-contain",
        className
      )}
      {...props}
    />
...
function ComboboxLabel({
  ...
  return (
    <ComboboxPrimitive.GroupLabel
      ...
      className={cn(
        "text-muted-foreground px-2 pt-2 pb-1 text-xs font-medium pointer-coarse:px-3",
        className
      )}
      {...props}
    />
